...
def main : IO Unit := do
  ...
  let mainContent :=
    imports ++ "\n\n" ++
    "namespace CoveringCodes.Database\n\n" ++
    "-- Auto-generated by `lake -KproofMode=native env lean --run Tools/TableGen/Main.lean`. Do not edit manually.\n" ++
    "-- Re-run `lake -KproofMode=native env lean --run Tools/TableGen/Main.lean` after source changes.\n" ++
  ...
  logProgress "Next step: build `CoveringCodes.Database.GeneratedAPI` to check the proof-carrying table."
