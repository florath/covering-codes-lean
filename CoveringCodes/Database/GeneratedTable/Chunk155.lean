...
def precomputedTable_chunk_155 : Array AnyBoundEntry := #[
  ...
  { key := { q := 16, n := 7, r := 4 }
    ...
    upperTrace := (.lengthenDummyN 2 (by decide : 0 < 16) (.lengthenFreeN 1 (.primitive "lean_hexadecimary_four_two_ca_upper" (primitiveUpper_valid 16 4 2)))) },
  { key := { q := 16, n := 7, r := 5 }
    lowerValue := 16
    upperValue := 87
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 16 7 5))
    upperTrace := (.lengthenDummyN 3 (by decide : 0 < 16) (.primitive "lean_hexadecimary_four_two_ca_upper" (primitiveUpper_valid 16 4 2))) },
  { key := { q := 16, n := 7, r := 6 }
    lowerValue := 16
    upperValue := 16
  ...
  { key := { q := 16, n := 8, r := 1 }
    ...
    upperTrace := (@UpperTrace.blockGroup 4 2 8 1 134217728 (@UpperTrace.blockGroup 2 2 16 1 134217728 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1))))) },
  { key := { q := 16, n := 8, r := 2 }
    lowerValue := 668894
    upperValue := 2752512
  ...
  { key := { q := 16, n := 8, r := 5 }
    ...
    upperTrace := (.lengthenDummyN 3 (by decide : 0 < 16) (.lengthenFreeN 1 (.primitive "lean_hexadecimary_four_two_ca_upper" (primitiveUpper_valid 16 4 2)))) },
  { key := { q := 16, n := 8, r := 6 }
    lowerValue := 16
    upperValue := 87
    lowerTrace := (.radiusBack (by decide : 6 ≤ 7) (.primitive "rule_radius_n_minus_one_exact" (primitiveLower_valid 16 8 7)))
    upperTrace := (.lengthenDummyN 4 (by decide : 0 < 16) (.primitive "lean_hexadecimary_four_two_ca_upper" (primitiveUpper_valid 16 4 2))) },
  { key := { q := 16, n := 8, r := 7 }
    lowerValue := 16
    upperValue := 16
  ...
  { key := { q := 16, n := 9, r := 1 }
    ...
    upperTrace := (@UpperTrace.alphabetExpand 8 16 2 9 1 2097152 (by decide : 0 < 8) (by decide : 0 < 2) (by decide : 16 ≤ 2 * 8) (by decide : 0 < 16) (.primitive "lean_extension_field_hamming_upper" (primitiveUpper_valid 8 9 1))) },
  { key := { q := 16, n := 9, r := 2 }
    lowerValue := 8343793
    upperValue := 44040192
  ...
  { key := { q := 16, n := 9, r := 6 }
    ...
    upperTrace := (.lengthenDummyN 4 (by decide : 0 < 16) (.lengthenFreeN 1 (.primitive "lean_hexadecimary_four_two_ca_upper" (primitiveUpper_valid 16 4 2)))) },
  { key := { q := 16, n := 9, r := 7 }
    lowerValue := 16
    upperValue := 87
    lowerTrace := (.radiusBack (by decide : 7 ≤ 8) (.primitive "rule_radius_n_minus_one_exact" (primitiveLower_valid 16 9 8)))
    upperTrace := (.lengthenDummyN 5 (by decide : 0 < 16) (.primitive "lean_hexadecimary_four_two_ca_upper" (primitiveUpper_valid 16 4 2))) },
  { key := { q := 16, n := 9, r := 8 }
    lowerValue := 16
    upperValue := 16
  ...
  { key := { q := 16, n := 10, r := 1 }
    ...
    upperTrace := (@UpperTrace.alphabetExpand 8 16 2 10 1 16777216 (by decide : 0 < 8) (by decide : 0 < 2) (by decide : 16 ≤ 2 * 8) (by decide : 0 < 16) (.lengthenFreeN 1 (.primitive "lean_extension_field_hamming_upper" (primitiveUpper_valid 8 9 1)))) },
  { key := { q := 16, n := 10, r := 2 }
  ...
  { key := { q := 16, n := 10, r := 7 }
    ...
    upperTrace := (.lengthenDummyN 5 (by decide : 0 < 16) (.lengthenFreeN 1 (.primitive "lean_hexadecimary_four_two_ca_upper" (primitiveUpper_valid 16 4 2)))) },
  { key := { q := 16, n := 10, r := 8 }
    lowerValue := 16
    upperValue := 87
    lowerTrace := (.radiusBack (by decide : 8 ≤ 9) (.primitive "rule_radius_n_minus_one_exact" (primitiveLower_valid 16 10 9)))
    upperTrace := (.lengthenDummyN 6 (by decide : 0 < 16) (.primitive "lean_hexadecimary_four_two_ca_upper" (primitiveUpper_valid 16 4 2))) },
  { key := { q := 16, n := 10, r := 9 }
    lowerValue := 16
    upperValue := 16
  ...
  { key := { q := 16, n := 11, r := 1 }
    ...
    upperTrace := (.lengthenFreeN 1 (@UpperTrace.alphabetExpand 8 16 2 10 1 16777216 (by decide : 0 < 8) (by decide : 0 < 2) (by decide : 16 ≤ 2 * 8) (by decide : 0 < 16) (.lengthenFreeN 1 (.primitive "lean_extension_field_hamming_upper" (primitiveUpper_valid 8 9 1))))) },
  { key := { q := 16, n := 11, r := 2 }
  ...
  { key := { q := 16, n := 11, r := 8 }
    ...
    upperTrace := (.lengthenDummyN 6 (by decide : 0 < 16) (.lengthenFreeN 1 (.primitive "lean_hexadecimary_four_two_ca_upper" (primitiveUpper_valid 16 4 2)))) },
  { key := { q := 16, n := 11, r := 9 }
    lowerValue := 16
    upperValue := 87
    lowerTrace := (.radiusBack (by decide : 9 ≤ 10) (.primitive "rule_radius_n_minus_one_exact" (primitiveLower_valid 16 11 10)))
    upperTrace := (.lengthenDummyN 7 (by decide : 0 < 16) (.primitive "lean_hexadecimary_four_two_ca_upper" (primitiveUpper_valid 16 4 2))) },
  { key := { q := 16, n := 11, r := 10 }
    lowerValue := 16
    upperValue := 16
