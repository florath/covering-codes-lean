...
def precomputedTable_chunk_146 : Array AnyBoundEntry := #[
  ...
  { key := { q := 15, n := 10, r := 7 }
    ...
    upperTrace := (.lengthenDummyN 3 (by decide : 0 < 15) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 15 6 4)))) },
  { key := { q := 15, n := 10, r := 8 }
    lowerValue := 15
    upperValue := 57
    lowerTrace := (.radiusBack (by decide : 8 ≤ 9) (.primitive "rule_radius_n_minus_one_exact" (primitiveLower_valid 15 10 9)))
    upperTrace := (.lengthenDummyN 4 (by decide : 0 < 15) (.primitive "lit_marosi_2026" (primitiveUpper_valid 15 6 4))) },
  { key := { q := 15, n := 10, r := 9 }
    lowerValue := 15
    upperValue := 15
  ...
  { key := { q := 15, n := 11, r := 8 }
    ...
    upperTrace := (.lengthenDummyN 4 (by decide : 0 < 15) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 15 6 4)))) },
  { key := { q := 15, n := 11, r := 9 }
    lowerValue := 15
    upperValue := 57
    lowerTrace := (.radiusBack (by decide : 9 ≤ 10) (.primitive "rule_radius_n_minus_one_exact" (primitiveLower_valid 15 11 10)))
    upperTrace := (.lengthenDummyN 5 (by decide : 0 < 15) (.primitive "lit_marosi_2026" (primitiveUpper_valid 15 6 4))) },
  { key := { q := 15, n := 11, r := 10 }
    lowerValue := 15
    upperValue := 15
  ...
  { key := { q := 15, n := 12, r := 9 }
    ...
    upperTrace := (.lengthenDummyN 5 (by decide : 0 < 15) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 15 6 4)))) },
  { key := { q := 15, n := 12, r := 10 }
    lowerValue := 15
    upperValue := 57
    lowerTrace := (.radiusBack (by decide : 10 ≤ 11) (.primitive "rule_radius_n_minus_one_exact" (primitiveLower_valid 15 12 11)))
    upperTrace := (.lengthenDummyN 6 (by decide : 0 < 15) (.primitive "lit_marosi_2026" (primitiveUpper_valid 15 6 4))) },
  { key := { q := 15, n := 12, r := 11 }
    lowerValue := 15
    upperValue := 15
  ...
  { key := { q := 15, n := 13, r := 10 }
    ...
    upperTrace := (.lengthenDummyN 6 (by decide : 0 < 15) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 15 6 4)))) },
  { key := { q := 15, n := 13, r := 11 }
    lowerValue := 15
    upperValue := 57
    lowerTrace := (.radiusBack (by decide : 11 ≤ 12) (.primitive "rule_radius_n_minus_one_exact" (primitiveLower_valid 15 13 12)))
    upperTrace := (.lengthenDummyN 7 (by decide : 0 < 15) (.primitive "lit_marosi_2026" (primitiveUpper_valid 15 6 4))) },
  { key := { q := 15, n := 13, r := 12 }
    lowerValue := 15
    upperValue := 15
  ...
  { key := { q := 15, n := 14, r := 11 }
    ...
    upperTrace := (.lengthenDummyN 7 (by decide : 0 < 15) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 15 6 4)))) },
  { key := { q := 15, n := 14, r := 12 }
    lowerValue := 15
    upperValue := 57
    lowerTrace := (.radiusBack (by decide : 12 ≤ 13) (.primitive "rule_radius_n_minus_one_exact" (primitiveLower_valid 15 14 13)))
    upperTrace := (.lengthenDummyN 8 (by decide : 0 < 15) (.primitive "lit_marosi_2026" (primitiveUpper_valid 15 6 4))) },
  { key := { q := 15, n := 14, r := 13 }
    lowerValue := 15
    upperValue := 15
