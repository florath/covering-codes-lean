...
def precomputedTable_chunk_28 : Array AnyBoundEntry := #[
  ...
  { key := { q := 2, n := 45, r := 1 }
    ...
    upperTrace := (.lengthenFreeN 14 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1))) },
  { key := { q := 2, n := 45, r := 2 }
    lowerValue := 33961749121
    upperValue := 549755813888
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 45 2))
    upperTrace := (.lengthenFreeN 12 (.lengthenDummyN 1 (by decide : 0 < 2) (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1))))) },
  { key := { q := 2, n := 45, r := 3 }
    lowerValue := 2310808623
    upperValue := 17179869184
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 45 3))
    upperTrace := (.lengthenFreeN 22 (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 2 23 3))) },
  { key := { q := 2, n := 45, r := 4 }
    lowerValue := 214250140
    upperValue := 8589934592
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 45 4))
    upperTrace := (.lengthenFreeN 21 (.primitive "lean_known_bounds_q2_n24_r4_binary_golay_tail" (primitiveUpper_valid 2 24 4))) },
  { key := { q := 2, n := 45, r := 5 }
    lowerValue := 25385917
    upperValue := 1073741824
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 45 5))
    upperTrace := (.lengthenFreeN 17 (.primitive "lean_known_bounds_q2_n28_r5_golay_antipodal_product" (primitiveUpper_valid 2 28 5))) },
  { key := { q := 2, n := 45, r := 6 }
    lowerValue := 3691557
  ...
  { key := { q := 2, n := 46, r := 1 }
    ...
    upperTrace := (.lengthenFreeN 15 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1))) },
  { key := { q := 2, n := 46, r := 2 }
    lowerValue := 65035807928
    upperValue := 1099511627776
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 46 2))
    upperTrace := (.lengthenFreeN 13 (.lengthenDummyN 1 (by decide : 0 < 2) (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1))))) },
  { key := { q := 2, n := 46, r := 3 }
    lowerValue := 4327188795
    upperValue := 34359738368
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 46 3))
    upperTrace := (.lengthenFreeN 23 (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 2 23 3))) },
  { key := { q := 2, n := 46, r := 4 }
    lowerValue := 392142216
    upperValue := 17179869184
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 46 4))
    upperTrace := (.lengthenFreeN 22 (.primitive "lean_known_bounds_q2_n24_r4_binary_golay_tail" (primitiveUpper_valid 2 24 4))) },
  { key := { q := 2, n := 46, r := 5 }
    lowerValue := 45393304
    upperValue := 2147483648
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 46 5))
    upperTrace := (.lengthenFreeN 18 (.primitive "lean_known_bounds_q2_n28_r5_golay_antipodal_product" (primitiveUpper_valid 2 28 5))) },
  { key := { q := 2, n := 46, r := 6 }
    lowerValue := 6445784
  ...
  { key := { q := 2, n := 47, r := 1 }
    ...
    upperTrace := (.lengthenFreeN 16 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1))) },
  { key := { q := 2, n := 47, r := 2 }
    lowerValue := 124656765594
    upperValue := 2199023255552
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 47 2))
    upperTrace := (.lengthenFreeN 14 (.lengthenDummyN 1 (by decide : 0 < 2) (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1))))) },
  { key := { q := 2, n := 47, r := 3 }
    lowerValue := 8114476958
    upperValue := 68719476736
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 47 3))
    upperTrace := (.lengthenFreeN 24 (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 2 23 3))) },
  { key := { q := 2, n := 47, r := 4 }
    lowerValue := 719116078
    upperValue := 34359738368
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 47 4))
    upperTrace := (.lengthenFreeN 23 (.primitive "lean_known_bounds_q2_n24_r4_binary_golay_tail" (primitiveUpper_valid 2 24 4))) },
  { key := { q := 2, n := 47, r := 5 }
    lowerValue := 81367706
    upperValue := 4294967296
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 47 5))
    upperTrace := (.lengthenFreeN 19 (.primitive "lean_known_bounds_q2_n28_r5_golay_antipodal_product" (primitiveUpper_valid 2 28 5))) },
  { key := { q := 2, n := 47, r := 6 }
    lowerValue := 11288602
    upperValue := 1073741824
  ...
  { key := { q := 2, n := 48, r := 1 }
    ...
    upperTrace := (.lengthenFreeN 17 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1))) },
  { key := { q := 2, n := 48, r := 2 }
    lowerValue := 239146114453
    upperValue := 4398046511104
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 48 2))
    upperTrace := (.lengthenFreeN 15 (.lengthenDummyN 1 (by decide : 0 < 2) (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1))))) },
  { key := { q := 2, n := 48, r := 3 }
    lowerValue := 15237101538
    upperValue := 137438953472
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 48 3))
    upperTrace := (.lengthenFreeN 25 (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 2 23 3))) },
  { key := { q := 2, n := 48, r := 4 }
    lowerValue := 1321150028
    upperValue := 68719476736
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 48 4))
    upperTrace := (.lengthenFreeN 24 (.primitive "lean_known_bounds_q2_n24_r4_binary_golay_tail" (primitiveUpper_valid 2 24 4))) },
  { key := { q := 2, n := 48, r := 5 }
    lowerValue := 146193655
    upperValue := 8589934592
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 2 48 5))
    upperTrace := (.lengthenFreeN 20 (.primitive "lean_known_bounds_q2_n28_r5_golay_antipodal_product" (primitiveUpper_valid 2 28 5))) },
  { key := { q := 2, n := 48, r := 6 }
    lowerValue := 19826554
    upperValue := 2147483648
