...
def precomputedTable_chunk_117 : Array AnyBoundEntry := #[
  ...
  { key := { q := 12, n := 9, r := 2 }
    ...
    upperTrace := (.lengthenFreeN 4 (.lengthenDummyN 1 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 9, r := 3 }
    lowerValue := 44382
    upperValue := 1492992
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 9 3))
    upperTrace := (.lengthenFreeN 3 (.lengthenDummyN 2 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 9, r := 4 }
    lowerValue := 2632
    upperValue := 124416
  ...
  { key := { q := 12, n := 9, r := 5 }
    ...
    upperTrace := (.lengthenFreeN 1 (.lengthenDummyN 4 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 9, r := 6 }
    lowerValue := 31
    upperValue := 864
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 9 6))
    upperTrace := (.lengthenDummyN 5 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1)))) },
  { key := { q := 12, n := 9, r := 7 }
    lowerValue := 12
    upperValue := 72
  ...
  { key := { q := 12, n := 10, r := 2 }
    ...
    upperTrace := (.lengthenFreeN 5 (.lengthenDummyN 1 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 10, r := 3 }
    lowerValue := 374631
    upperValue := 17915904
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 10 3))
    upperTrace := (.lengthenFreeN 4 (.lengthenDummyN 2 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 10, r := 4 }
    lowerValue := 19111
    upperValue := 1492992
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 10 4))
    upperTrace := (.lengthenFreeN 3 (.lengthenDummyN 3 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 10, r := 5 }
    lowerValue := 1413
    upperValue := 124416
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 10 5))
    upperTrace := (.lengthenFreeN 2 (.lengthenDummyN 4 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 10, r := 6 }
    lowerValue := 149
    upperValue := 10368
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 10 6))
    upperTrace := (.lengthenFreeN 1 (.lengthenDummyN 5 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 10, r := 7 }
    lowerValue := 23
    upperValue := 864
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 10 7))
    upperTrace := (.lengthenDummyN 6 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1)))) },
  { key := { q := 12, n := 10, r := 8 }
    lowerValue := 12
    upperValue := 72
  ...
  { key := { q := 12, n := 11, r := 2 }
    ...
    upperTrace := (.lengthenFreeN 6 (.lengthenDummyN 1 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 11, r := 3 }
    lowerValue := 3281956
    upperValue := 214990848
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 11 3))
    upperTrace := (.lengthenFreeN 5 (.lengthenDummyN 2 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 11, r := 4 }
    lowerValue := 146900
    upperValue := 17915904
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 11 4))
    upperTrace := (.lengthenFreeN 4 (.lengthenDummyN 3 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 11, r := 5 }
    lowerValue := 9351
    upperValue := 1492992
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 11 5))
    upperTrace := (.lengthenFreeN 3 (.lengthenDummyN 4 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 11, r := 6 }
    lowerValue := 828
    upperValue := 124416
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 11 6))
    upperTrace := (.lengthenFreeN 2 (.lengthenDummyN 5 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 11, r := 7 }
    lowerValue := 102
    upperValue := 10368
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 11 7))
    upperTrace := (.lengthenFreeN 1 (.lengthenDummyN 6 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 11, r := 8 }
    lowerValue := 18
    upperValue := 864
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 11 8))
    upperTrace := (.lengthenDummyN 7 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1)))) },
  { key := { q := 12, n := 11, r := 9 }
    lowerValue := 12
    upperValue := 72
  ...
  { key := { q := 12, n := 12, r := 2 }
    ...
    upperTrace := (.lengthenFreeN 7 (.lengthenDummyN 1 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 12, r := 3 }
    lowerValue := 29627601
    upperValue := 2579890176
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 12 3))
    upperTrace := (.lengthenFreeN 6 (.lengthenDummyN 2 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 12, r := 4 }
    lowerValue := 1181217
    upperValue := 214990848
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 12 4))
    upperTrace := (.lengthenFreeN 5 (.lengthenDummyN 3 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 12, r := 5 }
    lowerValue := 65996
    upperValue := 17915904
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 12 5))
    upperTrace := (.lengthenFreeN 4 (.lengthenDummyN 4 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 12, r := 6 }
    lowerValue := 5032
    upperValue := 1492992
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 12 6))
    upperTrace := (.lengthenFreeN 3 (.lengthenDummyN 5 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 12, r := 7 }
    lowerValue := 519
    upperValue := 124416
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 12 7))
    upperTrace := (.lengthenFreeN 2 (.lengthenDummyN 6 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 12, r := 8 }
    lowerValue := 73
    upperValue := 10368
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 12 8))
    upperTrace := (.lengthenFreeN 1 (.lengthenDummyN 7 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 12, r := 9 }
    lowerValue := 14
    upperValue := 864
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 12 9))
    upperTrace := (.lengthenDummyN 8 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1)))) },
  { key := { q := 12, n := 12, r := 10 }
    lowerValue := 12
    upperValue := 72
  ...
  { key := { q := 12, n := 13, r := 1 }
    ...
    upperTrace := (.lengthenFreeN 10 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))) },
  { key := { q := 12, n := 13, r := 2 }
    lowerValue := 11166061927
    upperValue := 371504185344
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 13 2))
    upperTrace := (.lengthenFreeN 8 (.lengthenDummyN 1 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 13, r := 3 }
    lowerValue := 274167211
    upperValue := 30958682112
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 13 3))
    upperTrace := (.lengthenFreeN 7 (.lengthenDummyN 2 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 13, r := 4 }
    lowerValue := 9853349
    upperValue := 2579890176
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 13 4))
    upperTrace := (.lengthenFreeN 6 (.lengthenDummyN 3 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 13, r := 5 }
    lowerValue := 490500
    upperValue := 214990848
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 13 5))
    upperTrace := (.lengthenFreeN 5 (.lengthenDummyN 4 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 13, r := 6 }
    lowerValue := 32839
    upperValue := 17915904
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 13 6))
    upperTrace := (.lengthenFreeN 4 (.lengthenDummyN 5 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 13, r := 7 }
    lowerValue := 2916
    upperValue := 1492992
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 13 7))
    upperTrace := (.lengthenFreeN 3 (.lengthenDummyN 6 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 13, r := 8 }
    lowerValue := 343
    upperValue := 124416
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 13 8))
    upperTrace := (.lengthenFreeN 2 (.lengthenDummyN 7 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 13, r := 9 }
    lowerValue := 54
    upperValue := 10368
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 13 9))
    upperTrace := (.lengthenFreeN 1 (.lengthenDummyN 8 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))))) },
  { key := { q := 12, n := 13, r := 10 }
    lowerValue := 12
    upperValue := 864
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 13 10))
    upperTrace := (.lengthenDummyN 9 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1)))) },
  { key := { q := 12, n := 13, r := 11 }
    lowerValue := 12
    upperValue := 12
  ...
  { key := { q := 12, n := 14, r := 1 }
    ...
    upperTrace := (.lengthenFreeN 11 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 12 3 1))) }]
