...
def precomputedTable_chunk_94 : Array AnyBoundEntry := #[
  ...
  { key := { q := 9, n := 39, r := 2 }
    ...
    upperTrace := (.lengthenFreeN 34 (.lengthenDummyN 1 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 9 3 1))))) },
  { key := { q := 9, n := 39, r := 3 }
    ...
    upperTrace := (.lengthenFreeN 33 (.lengthenDummyN 2 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 9 3 1))))) },
  { key := { q := 9, n := 39, r := 4 }
    ...
    upperTrace := (.lengthenFreeN 31 (.primitive "lean_known_bounds_q9_n8_r4_block_product" (primitiveUpper_valid 9 8 4))) },
  { key := { q := 9, n := 39, r := 5 }
    ...
    upperTrace := (.lengthenFreeN 30 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))) },
  { key := { q := 9, n := 39, r := 6 }
    ...
    upperTrace := (.lengthenFreeN 28 (.lengthenDummyN 1 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 39, r := 7 }
    ...
    upperTrace := (.lengthenFreeN 27 (.lengthenDummyN 2 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 39, r := 8 }
    ...
    upperTrace := (.lengthenFreeN 26 (.lengthenDummyN 3 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 39, r := 9 }
    ...
    upperTrace := (.lengthenFreeN 25 (.lengthenDummyN 4 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 39, r := 10 }
    ...
    upperTrace := (.lengthenFreeN 24 (.lengthenDummyN 5 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 39, r := 11 }
    ...
    upperTrace := (.lengthenFreeN 23 (.lengthenDummyN 6 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 39, r := 12 }
    ...
    upperTrace := (.lengthenFreeN 22 (.lengthenDummyN 7 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 39, r := 13 }
    ...
    upperTrace := (.lengthenFreeN 21 (.lengthenDummyN 8 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 39, r := 14 }
    ...
    upperTrace := (.lengthenFreeN 20 (.lengthenDummyN 9 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 39, r := 15 }
    ...
    upperTrace := (.lengthenFreeN 19 (.lengthenDummyN 10 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 39, r := 16 }
  ...
  { key := { q := 9, n := 40, r := 2 }
    ...
    upperTrace := (.lengthenFreeN 35 (.lengthenDummyN 1 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 9 3 1))))) },
  { key := { q := 9, n := 40, r := 3 }
    lowerValue := 28932195521874099875114182409216
    upperValue := 102629375704722905653938451429519809
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 40 3))
    upperTrace := (.lengthenFreeN 34 (.lengthenDummyN 2 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 9 3 1))))) },
  { key := { q := 9, n := 40, r := 4 }
    ...
    upperTrace := (.lengthenFreeN 32 (.primitive "lean_known_bounds_q9_n8_r4_block_product" (primitiveUpper_valid 9 8 4))) },
  { key := { q := 9, n := 40, r := 5 }
    lowerValue := 6736634768801450930125334128
    upperValue := 278128389443693511257285776231761
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 40 5))
    upperTrace := (.lengthenFreeN 31 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))) },
  { key := { q := 9, n := 40, r := 6 }
    lowerValue := 143762024024701538899978522
    upperValue := 30903154382632612361920641803529
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 40 6))
    upperTrace := (.lengthenFreeN 29 (.lengthenDummyN 1 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 40, r := 7 }
    lowerValue := 3683568826591185733106433
    upperValue := 3433683820292512484657849089281
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 40 7))
    upperTrace := (.lengthenFreeN 28 (.lengthenDummyN 2 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 40, r := 8 }
    lowerValue := 111103295809082714772806
    upperValue := 381520424476945831628649898809
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 40 8))
    upperTrace := (.lengthenFreeN 27 (.lengthenDummyN 3 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 40, r := 9 }
    lowerValue := 3886564234772420994303
    upperValue := 42391158275216203514294433201
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 40 9))
    upperTrace := (.lengthenFreeN 26 (.lengthenDummyN 4 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 40, r := 10 }
    lowerValue := 155883718300996230266
    upperValue := 4710128697246244834921603689
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 40 10))
    upperTrace := (.lengthenFreeN 25 (.lengthenDummyN 5 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 40, r := 11 }
    lowerValue := 7104000211836089127
    upperValue := 523347633027360537213511521
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 40 11))
    upperTrace := (.lengthenFreeN 24 (.lengthenDummyN 6 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 40, r := 12 }
    lowerValue := 365201673657011379
    upperValue := 58149737003040059690390169
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 40 12))
    upperTrace := (.lengthenFreeN 23 (.lengthenDummyN 7 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 40, r := 13 }
    lowerValue := 21055189926070258
    upperValue := 6461081889226673298932241
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 40 13))
    upperTrace := (.lengthenFreeN 22 (.lengthenDummyN 8 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 40, r := 14 }
    lowerValue := 1354984893284946
    upperValue := 717897987691852588770249
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 40 14))
    upperTrace := (.lengthenFreeN 21 (.lengthenDummyN 9 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 40, r := 15 }
    lowerValue := 96962688329285
    upperValue := 79766443076872509863361
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 40 15))
    upperTrace := (.lengthenFreeN 20 (.lengthenDummyN 10 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 40, r := 16 }
  ...
  { key := { q := 9, n := 41, r := 2 }
    ...
    upperTrace := (.lengthenFreeN 36 (.lengthenDummyN 1 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 9 3 1))))) },
  { key := { q := 9, n := 41, r := 3 }
    lowerValue := 241398091745958349584011279062616
    upperValue := 923664381342506150885446062865678281
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 41 3))
    upperTrace := (.lengthenFreeN 35 (.lengthenDummyN 2 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 9 3 1))))) },
  { key := { q := 9, n := 41, r := 4 }
    ...
    upperTrace := (.lengthenFreeN 33 (.primitive "lean_known_bounds_q9_n8_r4_block_product" (primitiveUpper_valid 9 8 4))) },
  { key := { q := 9, n := 41, r := 5 }
    lowerValue := 53261060100784050242068358186
    upperValue := 2503155504993241601315571986085849
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 41 5))
    upperTrace := (.lengthenFreeN 32 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))) },
  { key := { q := 9, n := 41, r := 6 }
    lowerValue := 1105179102521144090659125147
    upperValue := 278128389443693511257285776231761
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 41 6))
    upperTrace := (.lengthenFreeN 30 (.lengthenDummyN 1 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 41, r := 7 }
    lowerValue := 27512555455528519370905604
    upperValue := 30903154382632612361920641803529
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 41 7))
    upperTrace := (.lengthenFreeN 29 (.lengthenDummyN 2 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 41, r := 8 }
    lowerValue := 805553670940851552027678
    upperValue := 3433683820292512484657849089281
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 41 8))
    upperTrace := (.lengthenFreeN 28 (.lengthenDummyN 3 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 41, r := 9 }
    lowerValue := 27330558272143147397642
    upperValue := 381520424476945831628649898809
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 41 9))
    upperTrace := (.lengthenFreeN 27 (.lengthenDummyN 4 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 41, r := 10 }
    lowerValue := 1062145992288716319816
    upperValue := 42391158275216203514294433201
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 41 10))
    upperTrace := (.lengthenFreeN 26 (.lengthenDummyN 5 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 41, r := 11 }
    lowerValue := 46853997018607030191
    upperValue := 4710128697246244834921603689
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 41 11))
    upperTrace := (.lengthenFreeN 25 (.lengthenDummyN 6 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 41, r := 12 }
    lowerValue := 2328988113072406214
    upperValue := 523347633027360537213511521
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 41 12))
    upperTrace := (.lengthenFreeN 24 (.lengthenDummyN 7 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 41, r := 13 }
    lowerValue := 129683122169985529
    upperValue := 58149737003040059690390169
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 41 13))
    upperTrace := (.lengthenFreeN 23 (.lengthenDummyN 8 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 41, r := 14 }
    lowerValue := 8050309528823929
    upperValue := 6461081889226673298932241
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 41 14))
    upperTrace := (.lengthenFreeN 22 (.lengthenDummyN 9 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 41, r := 15 }
    lowerValue := 554960505277135
    upperValue := 717897987691852588770249
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 41 15))
    upperTrace := (.lengthenFreeN 21 (.lengthenDummyN 10 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 41, r := 16 }
  ...
  { key := { q := 9, n := 42, r := 2 }
    ...
    upperTrace := (.lengthenFreeN 37 (.lengthenDummyN 1 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 9 3 1))))) },
  { key := { q := 9, n := 42, r := 3 }
    lowerValue := 2017884643139853139747455046056429
    upperValue := 8312979432082555357969014565791104529
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 42 3))
    upperTrace := (.lengthenFreeN 36 (.lengthenDummyN 2 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 9 3 1))))) },
  { key := { q := 9, n := 42, r := 4 }
    ...
    upperTrace := (.lengthenFreeN 34 (.primitive "lean_known_bounds_q9_n8_r4_block_product" (primitiveUpper_valid 9 8 4))) },
  { key := { q := 9, n := 42, r := 5 }
    lowerValue := 422473559900249151956692122389
    upperValue := 22528399544939174411840147874772641
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 42 5))
    upperTrace := (.lengthenFreeN 33 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))) },
  { key := { q := 9, n := 42, r := 6 }
    lowerValue := 8530528655071770839613181425
    upperValue := 2503155504993241601315571986085849
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 42 6))
    upperTrace := (.lengthenFreeN 31 (.lengthenDummyN 1 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 42, r := 7 }
    lowerValue := 206489802781193952441708252
    upperValue := 278128389443693511257285776231761
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 42 7))
    upperTrace := (.lengthenFreeN 30 (.lengthenDummyN 2 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 42, r := 8 }
    lowerValue := 5874065716872901671276565
    upperValue := 30903154382632612361920641803529
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 42 8))
    upperTrace := (.lengthenFreeN 29 (.lengthenDummyN 3 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 42, r := 9 }
    lowerValue := 193464600963301433303195
    upperValue := 3433683820292512484657849089281
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 42 9))
    upperTrace := (.lengthenFreeN 28 (.lengthenDummyN 4 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 42, r := 10 }
    lowerValue := 7292156495985128558443
    upperValue := 381520424476945831628649898809
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 42 10))
    upperTrace := (.lengthenFreeN 27 (.lengthenDummyN 5 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 42, r := 11 }
    lowerValue := 311690280743261309807
    upperValue := 42391158275216203514294433201
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 42 11))
    upperTrace := (.lengthenFreeN 26 (.lengthenDummyN 6 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 42, r := 12 }
    lowerValue := 14997145799539848481
    upperValue := 4710128697246244834921603689
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 42 12))
    upperTrace := (.lengthenFreeN 25 (.lengthenDummyN 7 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 42, r := 13 }
    lowerValue := 807459357662120093
    upperValue := 523347633027360537213511521
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 42 13))
    upperTrace := (.lengthenFreeN 24 (.lengthenDummyN 8 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 42, r := 14 }
    lowerValue := 48411131710049219
    upperValue := 58149737003040059690390169
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 42 14))
    upperTrace := (.lengthenFreeN 23 (.lengthenDummyN 9 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 42, r := 15 }
    lowerValue := 3219251824677271
    upperValue := 6461081889226673298932241
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 42 15))
    upperTrace := (.lengthenFreeN 22 (.lengthenDummyN 10 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 42, r := 16 }
  ...
  { key := { q := 9, n := 43, r := 2 }
    ...
    upperTrace := (.lengthenFreeN 38 (.lengthenDummyN 1 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 9 3 1))))) },
  { key := { q := 9, n := 43, r := 3 }
    ...
    upperTrace := (.lengthenFreeN 37 (.lengthenDummyN 2 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_small_explicit_upper" (primitiveUpper_valid 9 3 1))))) },
  { key := { q := 9, n := 43, r := 4 }
    ...
    upperTrace := (.lengthenFreeN 35 (.primitive "lean_known_bounds_q9_n8_r4_block_product" (primitiveUpper_valid 9 8 4))) },
  { key := { q := 9, n := 43, r := 5 }
    lowerValue := 3361568322990445426758128973276
    upperValue := 202755595904452569706561330872953769
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 43 5))
    upperTrace := (.lengthenFreeN 34 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))) },
  { key := { q := 9, n := 43, r := 6 }
    lowerValue := 66097675683294225317552436365
    upperValue := 22528399544939174411840147874772641
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 43 6))
    upperTrace := (.lengthenFreeN 32 (.lengthenDummyN 1 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 43, r := 7 }
    lowerValue := 1556915002460912974026885124
    upperValue := 2503155504993241601315571986085849
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 43 7))
    upperTrace := (.lengthenFreeN 31 (.lengthenDummyN 2 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 43, r := 8 }
    lowerValue := 43065771513579263689024156
    upperValue := 278128389443693511257285776231761
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 43 8))
    upperTrace := (.lengthenFreeN 30 (.lengthenDummyN 3 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 43, r := 9 }
    lowerValue := 1378080533301932913890073
    upperValue := 30903154382632612361920641803529
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 43 9))
    upperTrace := (.lengthenFreeN 29 (.lengthenDummyN 4 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 43, r := 10 }
    lowerValue := 50424439582616850565109
    upperValue := 3433683820292512484657849089281
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 43 10))
    upperTrace := (.lengthenFreeN 28 (.lengthenDummyN 5 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 43, r := 11 }
    lowerValue := 2090406735044684205630
    upperValue := 381520424476945831628649898809
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 43 11))
    upperTrace := (.lengthenFreeN 27 (.lengthenDummyN 6 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 43, r := 12 }
    lowerValue := 97459703158603809164
    upperValue := 42391158275216203514294433201
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 43 12))
    upperTrace := (.lengthenFreeN 26 (.lengthenDummyN 7 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 43, r := 13 }
    lowerValue := 5079329931925900086
    upperValue := 4710128697246244834921603689
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 43 13))
    upperTrace := (.lengthenFreeN 25 (.lengthenDummyN 8 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 43, r := 14 }
    lowerValue := 294463828943963152
    upperValue := 523347633027360537213511521
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 43 14))
    upperTrace := (.lengthenFreeN 24 (.lengthenDummyN 9 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 43, r := 15 }
    lowerValue := 18912234205208918
    upperValue := 58149737003040059690390169
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 9 43 15))
    upperTrace := (.lengthenFreeN 23 (.lengthenDummyN 10 (by decide : 0 < 9) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q9_n9_r5_systematic_syndrome" (primitiveUpper_valid 9 9 5))))) },
  { key := { q := 9, n := 43, r := 16 }
