...
def precomputedTable_chunk_140 : Array AnyBoundEntry := #[
  ...
  { key := { q := 14, n := 29, r := 4 }
    ...
    upperTrace := (.lengthenFreeN 23 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))) },
  { key := { q := 14, n := 29, r := 5 }
    ...
    upperTrace := (.lengthenFreeN 21 (.lengthenDummyN 1 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 29, r := 6 }
    ...
    upperTrace := (.lengthenFreeN 20 (.lengthenDummyN 2 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 29, r := 7 }
    ...
    upperTrace := (.lengthenFreeN 19 (.lengthenDummyN 3 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 29, r := 8 }
    ...
    upperTrace := (.lengthenFreeN 18 (.lengthenDummyN 4 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 29, r := 9 }
    ...
    upperTrace := (.lengthenFreeN 17 (.lengthenDummyN 5 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 29, r := 10 }
    ...
    upperTrace := (.lengthenFreeN 16 (.lengthenDummyN 6 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 29, r := 11 }
    ...
    upperTrace := (.lengthenFreeN 15 (.lengthenDummyN 7 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 29, r := 12 }
    ...
    upperTrace := (.lengthenFreeN 14 (.lengthenDummyN 8 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 29, r := 13 }
  ...
  { key := { q := 14, n := 30, r := 4 }
    ...
    upperTrace := (.lengthenFreeN 24 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))) },
  { key := { q := 14, n := 30, r := 5 }
    lowerValue := 450651687015516221793174
    upperValue := 11479284644349074774111027200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 30 5))
    upperTrace := (.lengthenFreeN 22 (.lengthenDummyN 1 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 30, r := 6 }
    lowerValue := 8288894986000791327615
    upperValue := 819948903167791055293644800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 30 6))
    upperTrace := (.lengthenFreeN 21 (.lengthenDummyN 2 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 30, r := 7 }
    lowerValue := 185219996361016626510
    upperValue := 58567778797699361092403200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 30 7))
    upperTrace := (.lengthenFreeN 20 (.lengthenDummyN 3 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 30, r := 8 }
    lowerValue := 4933958760860334068
    upperValue := 4183412771264240078028800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 30 8))
    upperTrace := (.lengthenFreeN 19 (.lengthenDummyN 4 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 30, r := 9 }
    lowerValue := 154518089181978987
    upperValue := 298815197947445719859200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 30 9))
    upperTrace := (.lengthenFreeN 18 (.lengthenDummyN 5 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 30, r := 10 }
    lowerValue := 5630091868871163
    upperValue := 21343942710531837132800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 30 10))
    upperTrace := (.lengthenFreeN 17 (.lengthenDummyN 6 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 30, r := 11 }
    lowerValue := 236805851814106
    upperValue := 1524567336466559795200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 30 11))
    upperTrace := (.lengthenFreeN 16 (.lengthenDummyN 7 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 30, r := 12 }
    lowerValue := 11430187177347
    upperValue := 108897666890468556800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 30 12))
    upperTrace := (.lengthenFreeN 15 (.lengthenDummyN 8 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 30, r := 13 }
  ...
  { key := { q := 14, n := 31, r := 4 }
    ...
    upperTrace := (.lengthenFreeN 25 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))) },
  { key := { q := 14, n := 31, r := 5 }
    lowerValue := 5294444586342265128050130
    upperValue := 160709985020887046837554380800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 31 5))
    upperTrace := (.lengthenFreeN 23 (.lengthenDummyN 1 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 31, r := 6 }
    lowerValue := 93651463869398243164121
    upperValue := 11479284644349074774111027200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 31 6))
    upperTrace := (.lengthenFreeN 22 (.lengthenDummyN 2 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 31, r := 7 }
    lowerValue := 2009372703329318598988
    upperValue := 819948903167791055293644800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 31 7))
    upperTrace := (.lengthenFreeN 21 (.lengthenDummyN 3 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 31, r := 8 }
    lowerValue := 51307646014374324138
    upperValue := 58567778797699361092403200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 31 8))
    upperTrace := (.lengthenFreeN 20 (.lengthenDummyN 4 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 31, r := 9 }
    lowerValue := 1537357463871026368
    upperValue := 4183412771264240078028800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 31 9))
    upperTrace := (.lengthenFreeN 19 (.lengthenDummyN 5 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 31, r := 10 }
    lowerValue := 53486245000509541
    upperValue := 298815197947445719859200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 31 10))
    upperTrace := (.lengthenFreeN 18 (.lengthenDummyN 6 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 31, r := 11 }
    lowerValue := 2143330790381938
    upperValue := 21343942710531837132800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 31 11))
    upperTrace := (.lengthenFreeN 17 (.lengthenDummyN 7 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 31, r := 12 }
    lowerValue := 98325017043619
    upperValue := 1524567336466559795200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 31 12))
    upperTrace := (.lengthenFreeN 16 (.lengthenDummyN 8 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 31, r := 13 }
  ...
  { key := { q := 14, n := 32, r := 4 }
    ...
    upperTrace := (.lengthenFreeN 26 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))) },
  { key := { q := 14, n := 32, r := 5 }
    lowerValue := 62572682236385792257298698
    upperValue := 2249939790292418655725761331200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 32 5))
    upperTrace := (.lengthenFreeN 24 (.lengthenDummyN 1 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 32, r := 6 }
    lowerValue := 1065993072246264539893292
    upperValue := 160709985020887046837554380800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 32 6))
    upperTrace := (.lengthenFreeN 23 (.lengthenDummyN 2 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 32, r := 7 }
    lowerValue := 21995966826675175596778
    upperValue := 11479284644349074774111027200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 32 7))
    upperTrace := (.lengthenFreeN 22 (.lengthenDummyN 3 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 32, r := 8 }
    lowerValue := 539292188260919481112
    upperValue := 819948903167791055293644800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 32 8))
    upperTrace := (.lengthenFreeN 21 (.lengthenDummyN 4 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 32, r := 9 }
    lowerValue := 15489461190431610633
    upperValue := 58567778797699361092403200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 32 9))
    upperTrace := (.lengthenFreeN 20 (.lengthenDummyN 5 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 32, r := 10 }
    lowerValue := 515606978237660506
    upperValue := 4183412771264240078028800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 32 10))
    upperTrace := (.lengthenFreeN 19 (.lengthenDummyN 6 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 32, r := 11 }
    lowerValue := 19728961180621563
    upperValue := 298815197947445719859200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 32 11))
    upperTrace := (.lengthenFreeN 18 (.lengthenDummyN 7 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 32, r := 12 }
    lowerValue := 862298469064439
    upperValue := 21343942710531837132800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 32 12))
    upperTrace := (.lengthenFreeN 17 (.lengthenDummyN 8 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 32, r := 13 }
  ...
  { key := { q := 14, n := 33, r := 4 }
    ...
    upperTrace := (.lengthenFreeN 27 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))) },
  { key := { q := 14, n := 33, r := 5 }
    lowerValue := 743642239379305990324529336
    upperValue := 31499157064093861180160658636800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 33 5))
    upperTrace := (.lengthenFreeN 25 (.lengthenDummyN 1 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 33, r := 6 }
    lowerValue := 12217995625581889090845959
    upperValue := 2249939790292418655725761331200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 33 6))
    upperTrace := (.lengthenFreeN 24 (.lengthenDummyN 2 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 33, r := 7 }
    lowerValue := 242810716395950819600820
    upperValue := 160709985020887046837554380800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 33 7))
    upperTrace := (.lengthenFreeN 23 (.lengthenDummyN 3 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 33, r := 8 }
    lowerValue := 5725269315316732332780
    upperValue := 11479284644349074774111027200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 33 8))
    upperTrace := (.lengthenFreeN 22 (.lengthenDummyN 4 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 33, r := 9 }
    lowerValue := 157896465795596480395
    upperValue := 819948903167791055293644800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 33 9))
    upperTrace := (.lengthenFreeN 21 (.lengthenDummyN 5 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 33, r := 10 }
    lowerValue := 5038251032198968453
    upperValue := 58567778797699361092403200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 33 10))
    upperTrace := (.lengthenFreeN 20 (.lengthenDummyN 6 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 33, r := 11 }
    lowerValue := 184453450547406755
    upperValue := 4183412771264240078028800
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 33 11))
    upperTrace := (.lengthenFreeN 19 (.lengthenDummyN 7 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 33, r := 12 }
    lowerValue := 7698140346250379
    upperValue := 298815197947445719859200
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 14 33 12))
    upperTrace := (.lengthenFreeN 18 (.lengthenDummyN 8 (by decide : 0 < 14) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 14 6 4))))) },
  { key := { q := 14, n := 33, r := 13 }
