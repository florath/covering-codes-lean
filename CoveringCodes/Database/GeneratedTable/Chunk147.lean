...
def precomputedTable_chunk_147 : Array AnyBoundEntry := #[
  ...
  { key := { q := 15, n := 15, r := 12 }
    ...
    upperTrace := (.lengthenDummyN 8 (by decide : 0 < 15) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 15 6 4)))) },
  { key := { q := 15, n := 15, r := 13 }
    lowerValue := 15
    upperValue := 57
    lowerTrace := (.radiusBack (by decide : 13 ≤ 14) (.primitive "rule_radius_n_minus_one_exact" (primitiveLower_valid 15 15 14)))
    upperTrace := (.lengthenDummyN 9 (by decide : 0 < 15) (.primitive "lit_marosi_2026" (primitiveUpper_valid 15 6 4))) },
  { key := { q := 15, n := 15, r := 14 }
    lowerValue := 15
    upperValue := 15
  ...
  { key := { q := 15, n := 16, r := 13 }
    ...
    upperTrace := (.lengthenDummyN 9 (by decide : 0 < 15) (.lengthenFreeN 1 (.primitive "lit_marosi_2026" (primitiveUpper_valid 15 6 4)))) },
  { key := { q := 15, n := 16, r := 14 }
    lowerValue := 15
    upperValue := 15
