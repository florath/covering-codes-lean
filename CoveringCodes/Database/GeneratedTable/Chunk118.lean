...
def precomputedTable_chunk_118 : Array AnyBoundEntry := #[
  { key := { q := 12, n := 14, r := 2 }
    ...
    upperTrace := (.lengthenDummyN 1 (by decide : 0 < 12) (@UpperTrace.alphabetExpand 3 12 4 13 1 59049 (by decide : 0 < 3) (by decide : 0 < 4) (by decide : 12 ≤ 4 * 3) (by decide : 0 < 12) (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 3 13 1)))) },
  { key := { q := 12, n := 14, r := 3 }
  ...
  { key := { q := 12, n := 14, r := 5 }
    lowerValue := 3803354
    upperValue := 788299776
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 14 5))
    upperTrace := (.lengthenFreeN 6 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))) },
  { key := { q := 12, n := 14, r := 6 }
    lowerValue := 226939
    upperValue := 65691648
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 14 6))
    upperTrace := (.lengthenFreeN 4 (.lengthenDummyN 1 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 14, r := 7 }
    lowerValue := 17701
    upperValue := 5474304
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 14 7))
    upperTrace := (.lengthenFreeN 3 (.lengthenDummyN 2 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 14, r := 8 }
    lowerValue := 1793
    upperValue := 456192
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 14 8))
    upperTrace := (.lengthenFreeN 2 (.lengthenDummyN 3 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 14, r := 9 }
    lowerValue := 237
    upperValue := 38016
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 14 9))
    upperTrace := (.lengthenFreeN 1 (.lengthenDummyN 4 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 14, r := 10 }
    lowerValue := 41
    upperValue := 3168
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 14 10))
    upperTrace := (.lengthenDummyN 5 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5)))) },
  { key := { q := 12, n := 14, r := 11 }
    lowerValue := 12
    upperValue := 144
  ...
  { key := { q := 12, n := 15, r := 1 }
    ...
    upperTrace := (.lengthenFreeN 1 (@UpperTrace.alphabetExpand 3 12 4 14 1 177147 (by decide : 0 < 3) (by decide : 0 < 4) (by decide : 12 ≤ 4 * 3) (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 3 13 1))))) },
  { key := { q := 12, n := 15, r := 2 }
    ...
    upperTrace := (.lengthenDummyN 1 (by decide : 0 < 12) (@UpperTrace.alphabetExpand 3 12 4 14 1 177147 (by decide : 0 < 3) (by decide : 0 < 4) (by decide : 12 ≤ 4 * 3) (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 3 13 1))))) },
  { key := { q := 12, n := 15, r := 3 }
    lowerValue := 24911268303
    upperValue := 3962711310336
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 15 3))
    upperTrace := (.lengthenDummyN 2 (by decide : 0 < 12) (@UpperTrace.alphabetExpand 3 12 4 13 1 59049 (by decide : 0 < 3) (by decide : 0 < 4) (by decide : 12 ≤ 4 * 3) (by decide : 0 < 12) (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 3 13 1)))) },
  { key := { q := 12, n := 15, r := 4 }
  ...
  { key := { q := 12, n := 15, r := 5 }
    lowerValue := 30554962
    upperValue := 9459597312
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 15 5))
    upperTrace := (.lengthenFreeN 7 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))) },
  { key := { q := 12, n := 15, r := 6 }
    lowerValue := 1644135
    upperValue := 788299776
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 15 6))
    upperTrace := (.lengthenFreeN 5 (.lengthenDummyN 1 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 15, r := 7 }
    lowerValue := 114321
    upperValue := 65691648
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 15 7))
    upperTrace := (.lengthenFreeN 4 (.lengthenDummyN 2 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 15, r := 8 }
    lowerValue := 10176
    upperValue := 5474304
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 15 8))
    upperTrace := (.lengthenFreeN 3 (.lengthenDummyN 3 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 15, r := 9 }
    lowerValue := 1158
    upperValue := 456192
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 15 9))
    upperTrace := (.lengthenFreeN 2 (.lengthenDummyN 4 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 15, r := 10 }
    lowerValue := 169
    upperValue := 38016
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 15 10))
    upperTrace := (.lengthenFreeN 1 (.lengthenDummyN 5 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 15, r := 11 }
    lowerValue := 33
    upperValue := 1728
  ...
  { key := { q := 12, n := 16, r := 1 }
    ...
    upperValue := 5777633090469888
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 16 1))
    upperTrace := (@UpperTrace.alphabetExpand 4 12 3 16 1 134217728 (by decide : 0 < 4) (by decide : 0 < 3) (by decide : 12 ≤ 3 * 4) (by decide : 0 < 12) (@UpperTrace.blockGroup 2 2 16 1 134217728 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1))))) },
  { key := { q := 12, n := 16, r := 2 }
    lowerValue := 12579727760430
    upperValue := 570630428688384
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 16 2))
    upperTrace := (.lengthenDummyN 1 (by decide : 0 < 12) (.lengthenFreeN 1 (@UpperTrace.alphabetExpand 3 12 4 14 1 177147 (by decide : 0 < 3) (by decide : 0 < 4) (by decide : 12 ≤ 4 * 3) (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 3 13 1)))))) },
  { key := { q := 12, n := 16, r := 3 }
    lowerValue := 243250517916
    upperValue := 47552535724032
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 16 3))
    upperTrace := (.lengthenDummyN 2 (by decide : 0 < 12) (@UpperTrace.alphabetExpand 3 12 4 14 1 177147 (by decide : 0 < 3) (by decide : 0 < 4) (by decide : 12 ≤ 4 * 3) (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 3 13 1))))) },
  { key := { q := 12, n := 16, r := 4 }
    lowerValue := 6745956794
    upperValue := 3962711310336
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 16 4))
    upperTrace := (.lengthenDummyN 3 (by decide : 0 < 12) (@UpperTrace.alphabetExpand 3 12 4 13 1 59049 (by decide : 0 < 3) (by decide : 0 < 4) (by decide : 12 ≤ 4 * 3) (by decide : 0 < 12) (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 3 13 1)))) },
  { key := { q := 12, n := 16, r := 5 }
    lowerValue := 252962053
    upperValue := 113515167744
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 16 5))
    upperTrace := (.lengthenFreeN 8 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))) },
  { key := { q := 12, n := 16, r := 6 }
    lowerValue := 12393752
    upperValue := 9459597312
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 16 6))
    upperTrace := (.lengthenFreeN 6 (.lengthenDummyN 1 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 16, r := 7 }
    lowerValue := 777312
    upperValue := 788299776
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 16 7))
    upperTrace := (.lengthenFreeN 5 (.lengthenDummyN 2 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 16, r := 8 }
    lowerValue := 61697
    upperValue := 65691648
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 16 8))
    upperTrace := (.lengthenFreeN 4 (.lengthenDummyN 3 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 16, r := 9 }
    lowerValue := 6169
    upperValue := 5474304
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 16 9))
    upperTrace := (.lengthenFreeN 3 (.lengthenDummyN 4 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 16, r := 10 }
    lowerValue := 778
    upperValue := 456192
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 16 10))
    upperTrace := (.lengthenFreeN 2 (.lengthenDummyN 5 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 16, r := 11 }
    lowerValue := 125
    upperValue := 20736
  ...
  { key := { q := 12, n := 17, r := 1 }
    ...
    upperTrace := (@UpperTrace.alphabetExpand 4 12 3 17 1 536870912 (by decide : 0 < 4) (by decide : 0 < 3) (by decide : 12 ≤ 3 * 4) (by decide : 0 < 12) (.lengthenFreeN 1 (@UpperTrace.blockGroup 2 2 16 1 134217728 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1)))))) },
  { key := { q := 12, n := 17, r := 2 }
    lowerValue := 133297951618628
    upperValue := 5777633090469888
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 17 2))
    upperTrace := (.lengthenDummyN 1 (by decide : 0 < 12) (@UpperTrace.alphabetExpand 4 12 3 16 1 134217728 (by decide : 0 < 4) (by decide : 0 < 3) (by decide : 12 ≤ 3 * 4) (by decide : 0 < 12) (@UpperTrace.blockGroup 2 2 16 1 134217728 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1)))))) },
  { key := { q := 12, n := 17, r := 3 }
    lowerValue := 2407023259393
    upperValue := 570630428688384
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 17 3))
    upperTrace := (.lengthenDummyN 2 (by decide : 0 < 12) (.lengthenFreeN 1 (@UpperTrace.alphabetExpand 3 12 4 14 1 177147 (by decide : 0 < 3) (by decide : 0 < 4) (by decide : 12 ≤ 4 * 3) (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 3 13 1)))))) },
  { key := { q := 12, n := 17, r := 4 }
    lowerValue := 62029028153
    upperValue := 47552535724032
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 17 4))
    upperTrace := (.lengthenDummyN 3 (by decide : 0 < 12) (@UpperTrace.alphabetExpand 3 12 4 14 1 177147 (by decide : 0 < 3) (by decide : 0 < 4) (by decide : 12 ≤ 4 * 3) (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 3 13 1))))) },
  { key := { q := 12, n := 17, r := 5 }
    lowerValue := 2149086250
    upperValue := 1362182012928
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 17 5))
    upperTrace := (.lengthenFreeN 9 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))) },
  { key := { q := 12, n := 17, r := 6 }
    lowerValue := 96641232
    upperValue := 113515167744
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 17 6))
    upperTrace := (.lengthenFreeN 7 (.lengthenDummyN 1 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 17, r := 7 }
    lowerValue := 5519707
    upperValue := 9459597312
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 17 7))
    upperTrace := (.lengthenFreeN 6 (.lengthenDummyN 2 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 17, r := 8 }
    lowerValue := 395263
    upperValue := 788299776
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 17 8))
    upperTrace := (.lengthenFreeN 5 (.lengthenDummyN 3 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 17, r := 9 }
    lowerValue := 35253
    upperValue := 65691648
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 17 9))
    upperTrace := (.lengthenFreeN 4 (.lengthenDummyN 4 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 17, r := 10 }
    lowerValue := 3911
    upperValue := 5474304
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 17 10))
    upperTrace := (.lengthenFreeN 3 (.lengthenDummyN 5 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 17, r := 11 }
    lowerValue := 542
    upperValue := 248832
  ...
  { key := { q := 12, n := 18, r := 1 }
    ...
    upperTrace := (.lengthenFreeN 1 (@UpperTrace.alphabetExpand 4 12 3 17 1 536870912 (by decide : 0 < 4) (by decide : 0 < 3) (by decide : 12 ≤ 3 * 4) (by decide : 0 < 12) (.lengthenFreeN 1 (@UpperTrace.blockGroup 2 2 16 1 134217728 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1))))))) },
  { key := { q := 12, n := 18, r := 2 }
    lowerValue := 1422794638781811
    upperValue := 69331597085638656
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 18 2))
    upperTrace := (.lengthenDummyN 1 (by decide : 0 < 12) (@UpperTrace.alphabetExpand 4 12 3 17 1 536870912 (by decide : 0 < 4) (by decide : 0 < 3) (by decide : 12 ≤ 3 * 4) (by decide : 0 < 12) (.lengthenFreeN 1 (@UpperTrace.blockGroup 2 2 16 1 134217728 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1))))))) },
  { key := { q := 12, n := 18, r := 3 }
    lowerValue := 24097701393261
    upperValue := 5777633090469888
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 18 3))
    upperTrace := (.lengthenDummyN 2 (by decide : 0 < 12) (@UpperTrace.alphabetExpand 4 12 3 16 1 134217728 (by decide : 0 < 4) (by decide : 0 < 3) (by decide : 12 ≤ 3 * 4) (by decide : 0 < 12) (@UpperTrace.blockGroup 2 2 16 1 134217728 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1)))))) },
  { key := { q := 12, n := 18, r := 4 }
    lowerValue := 579949850877
    upperValue := 570630428688384
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 18 4))
    upperTrace := (.lengthenDummyN 3 (by decide : 0 < 12) (.lengthenFreeN 1 (@UpperTrace.alphabetExpand 3 12 4 14 1 177147 (by decide : 0 < 3) (by decide : 0 < 4) (by decide : 12 ≤ 4 * 3) (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 3 13 1)))))) },
  { key := { q := 12, n := 18, r := 5 }
    lowerValue := 18672672836
    upperValue := 16346184155136
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 18 5))
    upperTrace := (.lengthenFreeN 10 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))) },
  { key := { q := 12, n := 18, r := 6 }
    lowerValue := 775895281
    upperValue := 1362182012928
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 18 6))
    upperTrace := (.lengthenFreeN 8 (.lengthenDummyN 1 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 18, r := 7 }
    lowerValue := 40679054
    upperValue := 113515167744
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 18 7))
    upperTrace := (.lengthenFreeN 7 (.lengthenDummyN 2 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 18, r := 8 }
    lowerValue := 2653210
    upperValue := 9459597312
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 18 8))
    upperTrace := (.lengthenFreeN 6 (.lengthenDummyN 3 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 18, r := 9 }
    lowerValue := 213538
    upperValue := 788299776
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 18 9))
    upperTrace := (.lengthenFreeN 5 (.lengthenDummyN 4 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 18, r := 10 }
    lowerValue := 21136
    upperValue := 65691648
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 18 10))
    upperTrace := (.lengthenFreeN 4 (.lengthenDummyN 5 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) },
  { key := { q := 12, n := 18, r := 11 }
    lowerValue := 2575
    upperValue := 2985984
  ...
  { key := { q := 12, n := 19, r := 1 }
    ...
    upperTrace := (.lengthenFreeN 2 (@UpperTrace.alphabetExpand 4 12 3 17 1 536870912 (by decide : 0 < 4) (by decide : 0 < 3) (by decide : 12 ≤ 3 * 4) (by decide : 0 < 12) (.lengthenFreeN 1 (@UpperTrace.blockGroup 2 2 16 1 134217728 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1))))))) },
  { key := { q := 12, n := 19, r := 2 }
    lowerValue := 15285393013282759
    upperValue := 831979165027663872
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 19 2))
    upperTrace := (.lengthenDummyN 1 (by decide : 0 < 12) (.lengthenFreeN 1 (@UpperTrace.alphabetExpand 4 12 3 17 1 536870912 (by decide : 0 < 4) (by decide : 0 < 3) (by decide : 12 ≤ 3 * 4) (by decide : 0 < 12) (.lengthenFreeN 1 (@UpperTrace.blockGroup 2 2 16 1 134217728 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1)))))))) },
  { key := { q := 12, n := 19, r := 3 }
    lowerValue := 243758773859049
    upperValue := 69331597085638656
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 19 3))
    upperTrace := (.lengthenDummyN 2 (by decide : 0 < 12) (@UpperTrace.alphabetExpand 4 12 3 17 1 536870912 (by decide : 0 < 4) (by decide : 0 < 3) (by decide : 12 ≤ 3 * 4) (by decide : 0 < 12) (.lengthenFreeN 1 (@UpperTrace.blockGroup 2 2 16 1 134217728 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1))))))) },
  { key := { q := 12, n := 19, r := 4 }
    lowerValue := 5502663513928
    upperValue := 5777633090469888
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 19 4))
    upperTrace := (.lengthenDummyN 3 (by decide : 0 < 12) (@UpperTrace.alphabetExpand 4 12 3 16 1 134217728 (by decide : 0 < 4) (by decide : 0 < 3) (by decide : 12 ≤ 3 * 4) (by decide : 0 < 12) (@UpperTrace.blockGroup 2 2 16 1 134217728 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 31 1)))))) },
  { key := { q := 12, n := 19, r := 5 }
    lowerValue := 165468504074
    upperValue := 196154209861632
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 19 5))
    upperTrace := (.lengthenFreeN 11 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))) },
  { key := { q := 12, n := 19, r := 6 }
    lowerValue := 6390014925
    upperValue := 16346184155136
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 12 19 6))
    upperTrace := (.lengthenFreeN 9 (.lengthenDummyN 1 (by decide : 0 < 12) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q12_n8_r5_quotient_majority" (primitiveUpper_valid 12 8 5))))) }]
