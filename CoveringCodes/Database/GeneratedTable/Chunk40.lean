...
def precomputedTable_chunk_40 : Array AnyBoundEntry := #[
  ...
  { key := { q := 4, n := 9, r := 1 }
    ...
    upperTrace := (.lengthenFreeN 1 (@UpperTrace.blockGroup 2 2 8 1 4096 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 15 1))))) },
  { key := { q := 4, n := 9, r := 2 }
    lowerValue := 745
    upperValue := 4096
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 9 2))
    upperTrace := (.lengthenDummyN 1 (by decide : 0 < 4) (@UpperTrace.blockGroup 2 2 8 1 4096 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 15 1))))) },
  { key := { q := 4, n := 9, r := 3 }
    lowerValue := 101
    upperValue := 1024
  ...
  { key := { q := 4, n := 10, r := 1 }
    ...
    upperTrace := (.lengthenFreeN 2 (@UpperTrace.blockGroup 2 2 8 1 4096 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 15 1))))) },
  { key := { q := 4, n := 10, r := 2 }
    lowerValue := 2405
    upperValue := 16384
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 10 2))
    upperTrace := (.lengthenDummyN 1 (by decide : 0 < 4) (.lengthenFreeN 1 (@UpperTrace.blockGroup 2 2 8 1 4096 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 15 1)))))) },
  { key := { q := 4, n := 10, r := 3 }
    lowerValue := 286
    upperValue := 4096
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 10 3))
    upperTrace := (.puncture (by decide : 0 < 4) (@UpperTrace.blockGroup 2 2 11 3 4096 (.puncture (by decide : 0 < 2) (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 2 23 3))))) },
  { key := { q := 4, n := 10, r := 4 }
    lowerValue := 51
    upperValue := 512
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 10 4))
    upperTrace := (.puncture (by decide : 0 < 4) (.primitive "lean_known_bounds_q4_n11_r4_gf4_coset_syndrome" (primitiveUpper_valid 4 11 4))) },
  { key := { q := 4, n := 10, r := 5 }
    lowerValue := 13
    upperValue := 256
  ...
  { key := { q := 4, n := 11, r := 1 }
    ...
    upperTrace := (.lengthenFreeN 3 (@UpperTrace.blockGroup 2 2 8 1 4096 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 15 1))))) },
  { key := { q := 4, n := 11, r := 2 }
    lowerValue := 7929
    upperValue := 65536
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 11 2))
    upperTrace := (.lengthenFreeN 1 (.lengthenDummyN 1 (by decide : 0 < 4) (.lengthenFreeN 1 (@UpperTrace.blockGroup 2 2 8 1 4096 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 15 1))))))) },
  { key := { q := 4, n := 11, r := 3 }
    lowerValue := 842
    upperValue := 4096
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 11 3))
    upperTrace := (@UpperTrace.blockGroup 2 2 11 3 4096 (.puncture (by decide : 0 < 2) (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 2 23 3)))) },
  { key := { q := 4, n := 11, r := 4 }
    lowerValue := 133
    upperValue := 512
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 11 4))
    upperTrace := (.primitive "lean_known_bounds_q4_n11_r4_gf4_coset_syndrome" (primitiveUpper_valid 4 11 4)) },
  { key := { q := 4, n := 11, r := 5 }
    lowerValue := 30
    upperValue := 512
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 11 5))
    upperTrace := (.radiusMono (by decide : 4 ≤ 5) (.primitive "lean_known_bounds_q4_n11_r4_gf4_coset_syndrome" (primitiveUpper_valid 4 11 4))) },
  { key := { q := 4, n := 11, r := 6 }
    lowerValue := 9
    upperValue := 64
  ...
  { key := { q := 4, n := 12, r := 1 }
    ...
    upperTrace := (.lengthenFreeN 4 (@UpperTrace.blockGroup 2 2 8 1 4096 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 15 1))))) },
  { key := { q := 4, n := 12, r := 2 }
    lowerValue := 26589
    upperValue := 262144
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 12 2))
    upperTrace := (.lengthenFreeN 2 (.lengthenDummyN 1 (by decide : 0 < 4) (.lengthenFreeN 1 (@UpperTrace.blockGroup 2 2 8 1 4096 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 15 1))))))) },
  { key := { q := 4, n := 12, r := 3 }
    lowerValue := 2554
    upperValue := 8192
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 12 3))
    upperTrace := (@UpperTrace.blockGroup 2 2 12 3 8192 (.lengthenFreeN 1 (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 2 23 3)))) },
  { key := { q := 4, n := 12, r := 4 }
    lowerValue := 360
    upperValue := 2048
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 12 4))
    upperTrace := (.lengthenFreeN 1 (.primitive "lean_known_bounds_q4_n11_r4_gf4_coset_syndrome" (primitiveUpper_valid 4 11 4))) },
  { key := { q := 4, n := 12, r := 5 }
    lowerValue := 71
    upperValue := 512
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 12 5))
    upperTrace := (.lengthenDummyN 1 (by decide : 0 < 4) (.primitive "lean_known_bounds_q4_n11_r4_gf4_coset_syndrome" (primitiveUpper_valid 4 11 4))) },
  { key := { q := 4, n := 12, r := 6 }
    lowerValue := 19
    upperValue := 256
  ...
  { key := { q := 4, n := 13, r := 1 }
    ...
    upperTrace := (.lengthenFreeN 5 (@UpperTrace.blockGroup 2 2 8 1 4096 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 15 1))))) },
  { key := { q := 4, n := 13, r := 2 }
    lowerValue := 90444
    upperValue := 1048576
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 13 2))
    upperTrace := (.lengthenFreeN 3 (.lengthenDummyN 1 (by decide : 0 < 4) (.lengthenFreeN 1 (@UpperTrace.blockGroup 2 2 8 1 4096 (.lengthenFreeN 1 (.primitive "lean_binary_hamming_upper" (primitiveUpper_valid 2 15 1))))))) },
  { key := { q := 4, n := 13, r := 3 }
    lowerValue := 7929
    upperValue := 32768
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 13 3))
    upperTrace := (.lengthenFreeN 1 (@UpperTrace.blockGroup 2 2 12 3 8192 (.lengthenFreeN 1 (.primitive "lean_hamming_perfect_upper" (primitiveUpper_valid 2 23 3))))) },
  { key := { q := 4, n := 13, r := 4 }
    lowerValue := 1011
    upperValue := 8192
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 13 4))
    upperTrace := (.lengthenFreeN 2 (.primitive "lean_known_bounds_q4_n11_r4_gf4_coset_syndrome" (primitiveUpper_valid 4 11 4))) },
  { key := { q := 4, n := 13, r := 5 }
    lowerValue := 178
    upperValue := 2048
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 13 5))
    upperTrace := (.lengthenDummyN 1 (by decide : 0 < 4) (.lengthenFreeN 1 (.primitive "lean_known_bounds_q4_n11_r4_gf4_coset_syndrome" (primitiveUpper_valid 4 11 4)))) },
  { key := { q := 4, n := 13, r := 6 }
    lowerValue := 42
    upperValue := 512
    lowerTrace := (.primitive "rule_sphere_covering_bound" (primitiveLower_valid 4 13 6))
    upperTrace := (.lengthenDummyN 2 (by decide : 0 < 4) (.primitive "lean_known_bounds_q4_n11_r4_gf4_coset_syndrome" (primitiveUpper_valid 4 11 4))) },
  { key := { q := 4, n := 13, r := 7 }
    lowerValue := 13
    upperValue := 256
