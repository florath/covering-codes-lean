...
/-!
# K16 E01 profile LRAT kernel certificate — split leaf 003 (cube [-1, -2, 3])

Kernel-proved unsatisfiability of the E01 core CNF restricted to cube `[-1, -2, 3]`
(variables 1,2 false, variable 3 true), via `lrat_cnf_proof`.

## Data files needed
* `data/K_16_4_2/lrat/split_prefix_core/e01_core_with_cube_003.cnf`
* `data/K_16_4_2/lrat/split_prefix_core/e01_core_prefix_003_r00_c02.lrat` — 54.2 MB (exists)
...
lrat_cnf_proof e01SplitFormula003 e01SplitProof003
  (include_str "../../../data/K_16_4_2/lrat/split_prefix_core/e01_core_with_cube_003.cnf")
...
/-- Kernel-proved unsatisfiability of (E01 core CNF ∧ cube [-1, -2, 3]).
    The LRAT certificate is verified by Lean's kernel at elaboration time. -/
theorem e01Split003_unsat :
    ∀ v : Sat.Valuation, Sat.Valuation.satisfies_fmla v e01SplitFormula003 → False :=
  no_valuation_of_lrat_proof e01SplitProof003

end E01SplitFromLRAT003
end Database
end CoveringCodes
