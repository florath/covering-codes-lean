...
/-!
# K16 E01 profile LRAT kernel certificate — split leaf 005 (cube [-1, -2, -3, -4, 5])

Kernel-proved unsatisfiability of the E01 core CNF restricted to cube `[-1, -2, -3, -4, 5]`
(variables 1,2,3,4 false, variable 5 true), via `lrat_cnf_proof`.

## Data files needed
* `data/K_16_4_2/lrat/split_prefix_core/e01_core_with_cube_005.cnf`
* `data/K_16_4_2/lrat/split_prefix_core/e01_core_prefix_005_r00_c04.lrat` — 106.1 MB (exists)
...
lrat_cnf_proof e01SplitFormula005 e01SplitProof005
  (include_str "../../../data/K_16_4_2/lrat/split_prefix_core/e01_core_with_cube_005.cnf")
...
/-- Kernel-proved unsatisfiability of (E01 core CNF ∧ cube [-1, -2, -3, -4, 5]).
    The LRAT certificate is verified by Lean's kernel at elaboration time. -/
theorem e01Split005_unsat :
    ∀ v : Sat.Valuation, Sat.Valuation.satisfies_fmla v e01SplitFormula005 → False :=
  no_valuation_of_lrat_proof e01SplitProof005

end E01SplitFromLRAT005
end Database
end CoveringCodes
